    ...
    return Drawer(
      child: ListView(
        ...
        children: [
          ...
          ListTile(
            leading: Icon(Icons.edit_location, color: Colors.yellow),
            title: Text(
              "Manage Addresses",
            ...
            onTap: () async {
              ...
              if (!allowed) {
                final reverify = await showConfirmationDialog(context,
                    "You haven't verified your email address. This action is only allowed for verified users. please Verify your Email",
          ...
          ListTile(
            leading: Icon(Icons.edit_location, color: Colors.deepOrange),
            title: Text(
              "My Orders",
              style: TextStyle(fontSize: 16, color: Colors.black),
            ),
