...
class _BodyState extends State<Body> {
  final productCategories = <Map>[
    <String, dynamic>{
      ICON_KEY: "assets/icons/apple.svg",
      TITLE_KEY: "Apple Product",
      PRODUCT_TYPE_KEY: ProductType.Apple,
    },
    <String, dynamic>{
      ICON_KEY: "assets/icons/samsung.svg",
      TITLE_KEY: "Samsung Product",
      PRODUCT_TYPE_KEY: ProductType.Samsung,
    },
    <String, dynamic>{
      ICON_KEY: "assets/icons/playstation.svg",
      TITLE_KEY: "Playstation Product",
      PRODUCT_TYPE_KEY: ProductType.Playstation,
    },
    <String, dynamic>{
      ICON_KEY: "assets/icons/Anker.svg",
      TITLE_KEY: "Ankers",
      PRODUCT_TYPE_KEY: ProductType.Anker,
    },
    <String, dynamic>{
      ICON_KEY: "assets/icons/jbl.svg",
      TITLE_KEY: "JBL product",
      PRODUCT_TYPE_KEY: ProductType.JBL,
    },
    <String, dynamic>{
      ICON_KEY: "assets/icons/Phone.svg",
      TITLE_KEY: "OtherProduct",
      PRODUCT_TYPE_KEY: ProductType.OtherProducts,
    },
    <String, dynamic>{
      ICON_KEY: "assets/icons/Others.svg",
      TITLE_KEY: "Accesories",
              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: ProductsSection(
                    sectionTitle: "Favourite Product",
